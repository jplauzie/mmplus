...
NSAMPLES_EL = 100     # elastic minimize sample count
...
DYNAMICS_TIME = 1e-11  # 500 ps warm-up run before minimize, matches mumax3 test
...
magnet.C44 = 58e9
magnet.C12 = 166e9
magnet.eta = 1e15  # unused by minimize (damping term dropped), harmless to set
